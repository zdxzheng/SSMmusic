            ...
            <div class="pa10 bg-warning">
                <form class="form-inline" id="formSearch" action="?">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control class_geshou19" data-value="${param.geshou}" data-rule-required="true" data-msg-required="请填写歌手" id="geshou" name="geshou">
                        ...
                        <script>
                            $(".class_geshou19").val($(".class_geshou19").attr("data-value"));
                        </script>
                    </div>
                    <div class="form-group">
                        曲风

                        <select class="form-control class_qufeng20" data-value="${param.qufeng}" id="qufeng" name="qufeng">
                            <option value="">请选择</option>
                        ...
                        <script>
                            $(".class_qufeng20").val($(".class_qufeng20").attr("data-value"));
                        </script>
                    </div>
                    <div class="form-group">
                        歌曲名称
                    ...
                    <tbody>
                        <c:set var="i" value="0" /><c:forEach items="${list}" var="map"
                            ...
                            <tr id="${map.id}" pid="">
                                ...
                                <td><ssm:sql var="mapgeshou18" type="find">SELECT xingming,id FROM geshou where id='${map.geshou}'</ssm:sql>${mapgeshou18.xingming}</td>
                                <td>
                                    <ssm:sql var="mapqufeng19" type="find">SELECT qufengmingcheng,id FROM qufeng where id='${map.qufeng}'</ssm:sql>${mapqufeng19.qufengmingcheng}
                                </td>
                                ...
                                <td>
                                    ${map.issh}
                                    <a href="sh.do?id=${map.id}&yuan=${map.issh}&tablename=danqu">
