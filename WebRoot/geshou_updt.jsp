...
<div style="padding: 10px" class="admin-content">
    <div class="container">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">编辑歌手:</div>
            <div class="panel-body">
                <form action="geshouupdate.do" method="post" name="form1" id="form1">
                    <!-- form 标签开始 -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <input
                                    ...
                                    id="geshoubianhao"
                                    name="geshoubianhao"
                                    value="${Info.html(mmm.geshoubianhao)}"
                                />
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group" style="width: 250px">
                                    <input type="text" class="form-control" id="zhaopian" name="zhaopian" value="${Info.html(mmm.zhaopian)}" />
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <select
                                    class="form-control class_diqu12"
                                    data-value="${Info.html(mmm.diqu)}"
                                    data-rule-required="true"
                                ...
                                <script>
                                    $(".class_diqu12").val($(".class_diqu12").attr("data-value"));
                                </script>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <select
                                    class="form-control class_xingbie13"
                                ...
                                <script>
                                    $(".class_xingbie13").val($(".class_xingbie13").attr("data-value"));
                                </script>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <textarea
                                    ...
                                    name="gerenjianjie"
                                >
${Info.html(mmm.gerenjianjie)}</textarea
                                >
                            </div>
                        </div>
                    </div>
