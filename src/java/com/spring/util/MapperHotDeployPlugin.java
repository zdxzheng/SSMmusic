...
public class MapperHotDeployPlugin implements InitializingBean, ApplicationContextAware {
    ...
    private static final Logger logger = LoggerFactory.getLogger(MapperHotDeployPlugin.class);
    ...
    class WatchThread extends Thread {
        ...
        private void clearMap(String nameSpace) {
            ...
            Arrays
                .asList("mappedStatements", "caches", "resultMaps", "parameterMaps", "keyGenerators", "sqlFragments")
                .forEach(fieldName -> {
        ...
        private void reloadXml(Set<String> set) {
            ...
            List<Resource> list = Arrays.stream(getResource()).filter(p -> set.contains(p.getFilename())).collect(Collectors.toList());
