...
<div style="padding: 10px" class="admin-content">
    <div class="container">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">添加专辑:</div>
            <div class="panel-body">
                <form action="zhuanjiinsert.do" method="post" name="form1" id="form1">
                    <!-- form 标签开始 -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group" style="width: 250px">
                                    <input type="text" class="form-control" id="zhuanjitupian" name="zhuanjitupian" value="" />
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control class_faxinggeshou16" data-value="" id="faxinggeshou" name="faxinggeshou" style="width: 250px">
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <textarea id="zhuanjixiangqing" name="zhuanjixiangqing" style="max-width: 750px; width: 100%; height: 300px"></textarea>
                                <script>
                                    (function () {
